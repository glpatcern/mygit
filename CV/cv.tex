...
\begin{description}
\item[Languages and technologies]: Python, Go, C++ (db interaction, multithreading, web apps),
...
Official CERN Guide since 2004 and senior guide (\textquoteleft\emph{conferencier}\textquoteright) since 2011, for both public and VIP visits in Italian, English, and French.

Lecturer at the CERN Academic Training, with a series about \href{https://indico.cern.ch/event/1172806}{The Physics of Music}, co-authored with Prof. Isabella Masina, University of Ferrara, Italy.

Skiing instructor as of 2012 with a \emph{Moniteur Federal} license from the French Ski Federation,
contributed to the CERN Ski Club Boureau (Secretary in 2013 - 2016, President in 2016 - 2019).
