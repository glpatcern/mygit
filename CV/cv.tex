...
Service Manager, software and service developer for CERNBox, the cloud storage for all CERN users.
...
\item Invited to the ownCloud Conference 2017 in N{\"u}rnberg, Germany, regular contributor of the CS3 Workshops organized by the group
\end{CompactItemize}
...
\begin{description}
\item[Languages and technologies]: C++, Python, Go (db interaction, multithreading, web apps),
  SQL (all major RDBMSs), Hadoop, shell scripting, docker, UML.
\item[Operating systems]: Linux (SL/CentOS and Debian), MS Windows, MacOS X.
\item[Tools]: git, gdb/valgrind, puppet, CI toolchains (Gitlab, GitHub), \LaTeX, Office suites.
\end{description}
...
contributing to the CERN Ski Club Boureau with the role of secretary in the period 2013 - 2016 and president in the period 2016 - 2019.
...
Philippe Charpentier \newline \small philippe.charpentier@cern.ch & Former LHCb Data Handling Coordinator\\
